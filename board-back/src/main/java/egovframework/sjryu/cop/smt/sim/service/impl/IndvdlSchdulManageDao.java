package egovframework.sjryu.cop.smt.sim.service.impl;
...
import egovframework.sjryu.cop.smt.sim.service.IndvdlSchdulManageVO;
...
public class IndvdlSchdulManageDao extends EgovAbstractMapper {
	 ...
	 * @throws Exception
	 */
	// public List<?> selectIndvdlSchdulManageDetail(IndvdlSchdulManageVO
	// indvdlSchdulManageVO) throws Exception{
	// return list("IndvdlSchdulManage.selectIndvdlSchdulManageDetail",
	// indvdlSchdulManageVO);
	// }
